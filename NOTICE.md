...
The control objectives served by this software (`src/wizard/data/ai_act_control_objectives.csv`)
are domain data authored outside this repository and carry their own attribution.
